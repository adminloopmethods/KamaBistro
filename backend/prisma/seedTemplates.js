...
import homeLanding from "./templateLocationPage/Landing.json" assert {type: "json"};
...
import homeLandingTwo from "./templateLocationPage2/Landing.json" assert {type: "json"};
