...
const Header: React.FC<HeaderProps> = ({brand}) => {
  ...
  return (
    <header className="rounded-lg px-4 py-5 m-1 bg-white dark:bg-gray-900 flex items-center justify-between">
      <h1 className="text-xl dark:text-white font-bold gradient-clipped pl-8">
        {brand} CMS
      </h1>
